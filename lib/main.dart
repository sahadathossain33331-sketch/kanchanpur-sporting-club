...
class _AppControllerState extends State<AppController> {
  ...
  Future<void> _loadSession() async {
    ...
    try {
      ...
      // Auth account আছে কিন্তু profile নেই।
      // তাই Home Page খুলবে না।
      if (row == null) {
...
class _AuthPageState extends State<AuthPage> {
  ...
  Future<void> submit() async {
    ...
    if (!RegExp(r'^01[3-9]\d{8}$').hasMatch(mobile)) {
      _msg(
        'সঠিক ১১ সংখ্যার বাংলাদেশি মোবাইল নাম্বার দিন।',
      );
      return;
    }
    ...
    try {
      ...
      if (signup) {
        ...
        if (result.session != null) {
          ...
          _msg(
            'Account তৈরি হয়েছে। '
            'Supabase Email Confirmation চালু থাকলে '
      ...
      // ==========================================================
        ...
        /*
         * সরাসরি Supabase Auth।
         *
         * কোনো Edge Function নেই।
         * কোনো hyper-function নেই।
         */
        ...
        if (loggedInUser == null ||
            result.session == null) {
          throw Exception(
            'Username, Mobile Number অথবা Password ভুল।',
          );
        }

        // ========================================================
        // STEP 1
        // Auth metadata থেকে Username + Phone যাচাই
        // ========================================================

        final savedUsername =
            loggedInUser.userMetadata?['username']
                    ?.toString()
                    .trim() ??
                '';

        final savedPhone = normalizePhone(
          loggedInUser.userMetadata?['phone']
                  ?.toString() ??
              '',
        );
        ...
        // ========================================================
        // STEP 2
        // profiles table-এ account আছে কি না যাচাই
        // ========================================================
        ...
        if (profileRow == null) {
          ...
          throw Exception(
            'এই account-এর registered profile পাওয়া যায়নি।',
          );
        }

        // ========================================================
        // STEP 3
        // Database Username + Phone যাচাই
        // ========================================================

        final dbPhone = normalizePhone(
      ...
      body: ListView(
        ...
        children: [
          ...
          const _StatusCard(
            title: 'সদস্য আবেদন',
            value:
                'আবেদন করুন এবং Admin-এর যাচাইয়ের অপেক্ষা করুন',
            icon:
  ...
  Future<void> submit() async {
    ...
    try {
      ...
      if (image != null) {
        ...
        final path =
            '${current.id}/${DateTime.now().millisecondsSinceEpoch}.$ext';
      ...
      _msg(
        'আবেদন সফলভাবে জমা হয়েছে। Admin যাচাই করবে।',
      );
  ...
  Future<void> submit() async {
    ...
    if (account.text
        ...
        transaction.text
            ...
            .isEmpty) {
      _msg(
        'Account Number ও Transaction ID দিন।',
      );
      return;
    }
    ...
    try {
      ...
      _msg(
        'Payment তথ্য জমা হয়েছে। Admin যাচাই করবে।',
      );
...
class _RunningMessage
    extends StatefulWidget {
  const _RunningMessage();

  @override
  State<_RunningMessage> createState() =>
      _RunningMessageState();
}

class _RunningMessageState
    extends State<_RunningMessage>
